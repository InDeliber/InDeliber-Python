...
**好的程序设计风格和正确的文档可以让程序易读并防止出错。**

### 1.7.1 恰当的注释和注释风格
   + 程序开始的地方要有一个总结性的注释，来解释这个程序是干什么的、其重要特征以及所使用的独特技术。
   + 大型程序中，应该有注释介绍每个主要步骤以及任何难以读懂的内容
   + 注释简洁明了是非常重要的，不要密密麻麻也不要让它难以读懂

### 1.7.2 恰当的空格
   + 一致的空格风格可以让程序更加清晰并且易于阅读、调试以及维护
...
1. **语法错误来自代码构建过程中的错误**
   + 你会遇到的大多数常见错误都是语法错误
   + 任何程序设计语言都有自己的语法，你必遵从**语法规则**编写代码，如果违反了这些规则就会出现**语法错误**
   + 语法错误通常很容易被检查到，Python解释器会告诉你这些错误在哪里以及什么原因造成量这些错误，一些编辑器通常也可以直接检测到这些错误

2. 逻辑错误
   + 程序没有按照预期运行是时出现了逻辑错误
   + 语法错误和运行时错误很容易找到并且易于更正
   + 查找逻辑错误非常具有挑战性 
